  ...
  return (
    <section>
      ...
      <div className="prose prose-neutral dark:prose-invert space-y-4">
        ...
        <div className="mt-12 p-8 bg-neutral-900 rounded-xl border-2 border-neutral-700 shadow-xl hover:shadow-2xl transition-shadow duration-300">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                href="/cv"
                className="group relative inline-flex items-center justify-center px-4 py-2 text-sm font-bold text-white bg-neutral-800 hover:bg-neutral-700 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 border-2 border-neutral-600 ring-2 ring-neutral-500/50 hover:ring-4 hover:ring-neutral-400/60 before:absolute before:inset-0 before:bg-gradient-to-r before:from-white/20 before:to-transparent before:rounded-full before:opacity-0 hover:before:opacity-100 before:transition-opacity before:duration-300 overflow-hidden no-underline"
              >
              ...
              <div className="flex items-center gap-4 text-sm text-neutral-600 dark:text-neutral-400">
                <span className="flex items-center gap-2 px-3 py-2 bg-neutral-50 dark:bg-neutral-950/30 rounded-full border border-neutral-200 dark:border-neutral-800">
            ...
            <div className="mt-8 flex justify-center gap-8 text-sm">
              <span className="flex items-center gap-2 px-4 py-2 bg-neutral-50 dark:bg-neutral-950/30 rounded-full border border-neutral-200 dark:border-neutral-800 shadow-sm">
